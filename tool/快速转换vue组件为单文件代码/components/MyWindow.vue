        ...
        <div>
            ...
            <div class="msg-flex">
                <div class="label">
                    <div class="flex-pair">
                        设备宽度
                        <div class="flex-data">{{ client.width }}</div>
                    </div>
                    <div class="flex-pair">
                        网格位置
                        <div class="flex-data">
                ...
                <div class="label">
                    <div class="flex-pair">
                        方块大小
                        <div class="flex-data">{{ cube.size }}</div>
                    </div>
                    <div class="flex-pair">
                        方块左上角相对网格位置
                        <div class="flex-data">({{ cube.x }},{{ cube.y }})</div>
                    </div>
                    <div class="flex-pair">
                        方块中心相对网格中心偏移
                        <div class="flex-data">
